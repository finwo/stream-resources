...
const col_accent = [0xFF, 0xD7, 0x00];
const col_back   = [0x00, 0x00, 0x00];
...
const img = {
  data: loadSvg(path.join(__dirname, '..', '..', 'assets', '0004-mv60-logo', 'MV_L_SITE_2_lines.svg')),
